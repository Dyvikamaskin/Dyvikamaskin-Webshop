...
**Scope.** Self-contained work area at `industriparts/data/`. Not
...
> [`../handoff.md`](../handoff.md)** — specifically the
...
> [`data-sources.md`](data-sources.md)** — SKU prefix
...
> **The canonical TODO list lives in [`../handoff.md`](../handoff.md)**
...
7. **Architecture target** — see `docs/data-sources.md` §9 (3-environment
...
- **Taxonomy correction**: `1xxxxxxxxx` is the WN Group post-SAP range for
  **big-equipment + agricultural** (verified on EZ80, TH627), not just
  Weidemann/Kramer. Old hypothesis corrected in `docs/data-sources.md` §1.
